...
Policy Number, Customer ID, Gender, Age, Policy Type, Policy Start Date, Policy End Date, Premium Amount, Coverage Amount, Claim Number, Claim Date, Claim Amount, Claim Status
...
Which policy types generate the highest premiums?How many policies are currently active vs inactive?
...
Shows count of:
Male customersFemale customers
